...
import com.lucataddeo.datacollectionapp.utils.Util;
...
public class DfuUtil {
    ...
    public static void runDfuServiceUpdate(Context context, String macAddress, String deviceName,
        ...
        if (fileStreamUri == null && filePath == null) {
            Toast.makeText(context, "File not valid", Toast.LENGTH_LONG).show();
            Log.e(TAG, "fileStreamUri: " + fileStreamUri);
            Log.e(TAG, "filePath: " + filePath);
            Log.e(TAG, "runDfuServiceUpdate: file stream and path not valid");
            return;
        }
        ...
        mServiceInitiator.setPrepareDataObjectDelay(300L);
        mServiceInitiator.createDfuNotificationChannel(context);
