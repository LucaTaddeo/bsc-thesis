...
import com.lucataddeo.datacollectionapp.model.EnergyGetModel;
import com.lucataddeo.datacollectionapp.model.MdsAddressModel;
import com.lucataddeo.datacollectionapp.model.MdsConnectedDevice;
import com.lucataddeo.datacollectionapp.model.MdsDeviceInfoNewSw;
import com.lucataddeo.datacollectionapp.model.MdsDeviceInfoOldSw;
import com.lucataddeo.datacollectionapp.model.MdsInfo;
...
public class DfuPresenter implements DfuContract.Presenter {
    ...
    private CompositeDisposable scanningSubcription;
    ...
    public DfuPresenter(Context context, DfuContract.View view, NotificationManager notificationManager) {
        ...
        scanningSubcription = new CompositeDisposable();
    }
    ...
    private void startUpdatingProcess(final Context context, boolean isIncrementationNeeded) {
        Log.e(TAG, "startUpdatingProcess: mFileStreamUri " + mFileStreamUri + "mFile " + mFilePath);
            ...
            if (mMdsAddressModelList != null && mMdsAddressModelList.size() == 2) {
                ...
                scanningSubcription.add(RxBle.Instance.getClient().scanBleDevices()
                        ...
                        .subscribe(new Consumer<RxBleScanResult>() {
                            @Override
                            public void accept(RxBleScanResult scanResult) {
    ...
    public void registerConnectedDeviceObservable(final Context context) {
        mCompositeSubscription.add(MdsRx.Instance.connectedDeviceObservable()
                ...
                .subscribe(new Consumer<MdsConnectedDevice>() {
                    @Override
                    public void accept(final MdsConnectedDevice mdsConnectedDevice) {
